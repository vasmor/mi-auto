        ...
        carbon_set_post_meta( $home_id, 'miauto_svc_details_tabs', array(
            array(
                ...
                'features'    => array(
                    ...
                    array( 'text' => 'Проверка и смазка шарниров в.т.ч карданных' ),
            ...
            array(
                ...
                'features'    => array(
                    array( 'text' => 'Замена ГРМ' ),
                    array( 'text' => 'Замена приводных ремней' ),
                    array( 'text' => 'Замена двигателя' ),
                    array( 'text' => 'Капитальный ремонт двигателя' ),
            ...
            array(
                ...
                'features'    => array(
                    array( 'text' => 'Диагностика АКПП' ),
                    array( 'text' => 'Замена масла в АКПП' ),
                    array( 'text' => 'Ремонт гидроблока' ),
                    array( 'text' => 'Замена гидротрансформатора' ),
                    array( 'text' => 'Ремонт мехатроника' ),
                    array( 'text' => 'Замена фрикционов' ),
                ),
                'price_label' => 'Стоимость работ от',
                'price_value' => 'от 5 000 ₽',
                'cta_text'    => 'Записаться на ремонт',
            ...
            array(
                ...
                'features'    => array(
                    array( 'text' => 'Диагностика МКПП' ),
                    array( 'text' => 'Замена масла в МКПП' ),
                    array( 'text' => 'Замена сцепления' ),
                    array( 'text' => 'Замена подшипников' ),
                    array( 'text' => 'Ремонт кулисы переключения' ),
                    array( 'text' => 'Замена сальников КПП' ),
                ),
                'price_label' => 'Стоимость работ от',
                'price_value' => 'от 3 500 ₽',
                'cta_text'    => 'Записаться на ремонт',
            ...
            array(
                ...
                'features'    => array(
                    array( 'text' => 'Диагностика MUT III' ),
                    array( 'text' => 'Установка электрооборудования' ),
                    array( 'text' => 'Демонтаж электрооборудования' ),
                    array( 'text' => 'Ремонт электрооборудования' ),
                    array( 'text' => 'Чтение/сброс ошибок' ),
                ),
                'price_label' => 'Стоимость работ от',
                'price_value' => 'от 500 ₽',
                'cta_text'    => 'Записаться на ремонт',
            ...
            array(
                ...
                'features'    => array(
                    array( 'text' => 'Снятие/установка колёс' ),
                    array( 'text' => 'Монтаж/демонтаж шин' ),
                    array( 'text' => 'Балансировка колёс' ),
                    array( 'text' => 'Подкачка шин азотом' ),
                    array( 'text' => 'Ремонт проколов' ),
                ),
                'price_label' => 'Стоимость работ от',
                'price_value' => 'от 500 ₽',
                'cta_text'    => 'Записаться на ремонт',
            ...
            array(
                ...
                'features'    => array(
                    array( 'text' => 'Замена тормозных колодок' ),
                    array( 'text' => 'Замена тормозных дисков' ),
                    array( 'text' => 'Проточка тормозных дисков' ),
                    array( 'text' => 'Ремонт суппортов' ),
                    array( 'text' => 'Замена тормозных шлангов' ),
                    array( 'text' => 'Замена датчиков ABS' ),
                    array( 'text' => 'Замена тормозных цилиндров' ),
                    array( 'text' => 'Прокачка тормозной системы' ),
                    array( 'text' => 'Замена тормозной жидкости' ),
                ),
                'price_label' => 'Стоимость работ от',
            ...
            array(
                ...
                'features'    => array(
                    array( 'text' => 'Диагностика углов установки колёс' ),
                    array( 'text' => 'Регулировка схождения' ),
                    array( 'text' => 'Регулировка развала' ),
                    array( 'text' => 'Проверка и регулировка кастора' ),
                    array( 'text' => 'Контрольный замер после регулировки' ),
                ),
                'price_label' => 'Стоимость работ от',
            ...
            array(
                ...
                'features'    => array(
                    array( 'text' => 'Диагностика топливной системы' ),
                    array( 'text' => 'Чистка и замена форсунок' ),
                    array( 'text' => 'Замена топливного насоса' ),
                    array( 'text' => 'Замена топливного фильтра' ),
                    array( 'text' => 'Ремонт топливной рампы' ),
                    array( 'text' => 'Проверка давления топлива' ),
                ),
                'price_label' => 'Стоимость работ от',
                'price_value' => 'от 2 000 ₽',
                'cta_text'    => 'Записаться на ремонт',
            ...
            array(
                ...
                'features'    => array(
                    array( 'text' => 'Диагностика рулевого управления' ),
                    array( 'text' => 'Ремонт рулевой рейки' ),
                    array( 'text' => 'Замена рулевых наконечников' ),
                    array( 'text' => 'Замена рулевых тяг' ),
                    array( 'text' => 'Ремонт/замена насоса ГУР' ),
                    array( 'text' => 'Замена жидкости ГУР' ),
                ),
                'price_label' => 'Стоимость работ от',
            ...
            array(
                ...
                'features'    => array(
                    array( 'text' => 'Диагностика системы охлаждения' ),
                    array( 'text' => 'Замена охлаждающей жидкости' ),
                    array( 'text' => 'Замена термостата' ),
                    array( 'text' => 'Замена водяного насоса' ),
                    array( 'text' => 'Ремонт/замена радиатора' ),
                    array( 'text' => 'Замена патрубков и шлангов' ),
                ),
                'price_label' => 'Стоимость работ от',
                'price_value' => 'от 2 000 ₽',
                'cta_text'    => 'Записаться на ремонт',
            ...
            array(
                ...
                'features'    => array(
                    array( 'text' => 'Диагностика MUT III' ),
                    array( 'text' => 'Считывание кодов ошибок' ),
                    array( 'text' => 'Диагностика двигателя' ),
                    array( 'text' => 'Диагностика АКПП/МКПП' ),
                    array( 'text' => 'Диагностика ABS и ESP' ),
                    array( 'text' => 'Диагностика подушек безопасности' ),
                ),
                'price_label' => 'Стоимость работ от',
                'price_value' => 'от 500 ₽',
                'cta_text'    => 'Записаться на ремонт',
            ...
            array(
                ...
                'features'    => array(
                    array( 'text' => 'Диагностика трансмиссии' ),
                    array( 'text' => 'Ремонт/замена карданного вала' ),
                    array( 'text' => 'Ремонт раздаточной коробки' ),
                    array( 'text' => 'Замена ШРУСов и пыльников' ),
                    array( 'text' => 'Замена масла в раздатке' ),
                    array( 'text' => 'Ремонт муфты подключения 4WD' ),
                ),
                'price_label' => 'Стоимость работ от',
